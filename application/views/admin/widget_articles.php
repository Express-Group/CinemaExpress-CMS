...
$(document).ready(function () {
	...
	function format ( d ) {		
		...
		var img_caption = '<input type="text" id="home_image_caption' + d.ContentId + '" name="home_image_caption' + d.ContentId + '" value="'+ custom_image_caption + '" class="margin-top-5 WidthFull" maxlength="200" >';
		var img_alt		= '<input type="text" id="home_image_alt' + d.ContentId + '" name="home_image_alt' + d.ContentId + '" value="'+ custom_image_alt + '" class="margin-top-5 WidthFull"  maxlength="200" >';
...
echo define_section_content_type($sectoin_nam3e, $content_type_list);
		  ...
		  function define_section_content_type($section_name, $content_type_list)
		  {
			  ...
			  $english_section_name_list 	= array("Gallery"=>'Photos', "Video"=>'Videos', "Audio"=>'Audios', "Resources"=>'Resources');			  
