		...
		<div class="Overflow DropDownWrapper">
			<div class="FloatLeft TableColumn"> 
				<div class="FloatLeft TableColumnSearch">
					...
					<button onclick="window.location.href='<?php echo base_url(folder_name.'/livenow'); ?>'" class="btn btn-primary" type="reset" id="clear_search">Clear Search</button>
					</form>
				</div>
			</div>
			<div id="example_wrapper">
				<table class="table" id="livetable">
					...
					foreach($articles as $article){
						...
						echo '</td>';
						echo '<td><a target="_BLANK" href="'.base_url(folder_name.'/livenow/add/'.$article['content_id']).'" style="padding: 4px 7px !important;font-size: 12px;" class="btn btn-primary" ><i class="fa fa-pencil"></i></a></td>';
						echo '</tr>';
					}
					?>
					</tbody>
