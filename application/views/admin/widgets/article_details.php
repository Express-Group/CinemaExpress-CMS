...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ArticleDetail">
   ...
   <div class="author_img">a
		<?php  if($author_image!=''){?> 
		<img class="img-circle" alt="" src="<?php echo image_url.$author_image;?>">
		<?php }else{ ?>
		<img class="img-circle" alt="" src="<?php echo image_url.'images/static_img/no_author.jpg';?>">
		<?php }?>
	</div> 
   <div class="author_publish">
   <?php if($is_author==1 && $is_agency==1){ ?>
			<span class="author_name"><a href="<?php echo base_url().$author_url_new;?>" target="_blank" >
			<?php echo $author_name;?></a>	</span>
      <?php }else if($author_name!=''){ ?>
			<span class="author_name" style="float:left;">
				<a href="<?php echo base_url().$author_url_new;?>" target="_blank" style="float: unset !important;"><?php echo $author_name;?>Auth</a>
				<br><div>Published: <?php echo $published_date;?></div>
			</span>  
   ...
   <?php
		if($author_name!=''):  
			...
			echo '&nbsp;&nbsp; | &nbsp;&nbsp; <a href="'.$twitter_link.'" target="_blank"><span style="color:#1da1f2;"><i class="fa fa-twitter" aria-hidden="true" style="font-size: 20px;color: #1da1f2;padding: 0px 10px 1px 0px;"></i>'.$author_name.'</a>';
			?>
			</p></div>
	<?php endif; ?>
  </div>
