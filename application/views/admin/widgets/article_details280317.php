...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ArticleDetail ArticleDetailContent <?php echo $special_class;?>">
  <div id="content" class="content" itemprop="description">
	...
	if($Rating!=0){
		...
		for($m=1;$m <=5 ;$m++){
			if($m > $Rating){
				echo '<i class="fa fa-star star-failure" aria-hidden="true"></i>';
			}else{
				echo '<i class="fa fa-star star-success" aria-hidden="true"></i>';
			}
		}
		echo '</div>';
...
s.src = 'https://staging-cinemaexpress-com.disqus.com/embed.js';
