	...
	if(count($widget_contents) > 0 ){
		...
		foreach($widget_contents as $get_content)
		{
		   ...
		   $custom_summary  = preg_replace('/<p[^>]*>(.*)<\/p[^>]*>/i', '$1',$custom_summary);  //to remove first<p> and last</p>  tag
			...
			/*if($i == 1)
			{*/
				$show_simple_tab .='<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:#f7edde;"><div class="margin-bottom-15 Overflow"><div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 SpecialLeadStory_3">';
				...
				$show_simple_tab .='<figure><img src="'.$dummy_image.'" data-src="'.$show_image.'"></figure></div></div></div>';		
			/*}*/	
			$i =$i+1;							  
