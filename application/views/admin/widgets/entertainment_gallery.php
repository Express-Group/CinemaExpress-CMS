...
if(count($widget_contents)>0)
{
	...
	$gallery_summary = stripslashes($get_content['summary_html']);
	...
	if($i<=4)
	{
		...
		$show_simple_tab .='<div class="Entergallery_Caption"> <p>'.$display_title.'</p></div></a>';
		$show_simple_tab .='<a  href="'.$live_article_url.'" class="article_click" ><figure class="PositionRelative">
		...
		//$show_simple_tab .='<div> <p>'.$gallery_summary.'</p></div>';
