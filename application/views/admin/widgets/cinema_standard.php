...
if(count($widget_contents)>0)
{
	foreach($widget_contents as $get_content) // For Get Content Start Here 
	{
		...
		// Assign summary block starts here
		////////  For first Article  /////////
		$summary = strlen($summary) > 135 ? substr($summary,0,135)."..." : $summary;
		if($i==1)
		{
			...
			$show_simple_tab.= '<div class="news_left cinema_standard_video_small">';
			$show_simple_tab.= '<a  href="'.$live_article_url.'" class="article_click"  >
			<img class="ImageBorder" src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"><i class="fa fa-camera gallery_camera-iconbig" aria-hidden="true"></i></a>';
			...
			<img class="ImageBorder" src="'.$dummy_image.'" data-src="'.$show_image.'" title = "'.$imagetitle.'" alt = "'.$imagealt.'"><i class="fa fa-camera gallery_camera-iconbig_1" aria-hidden="true"></i></a>';
