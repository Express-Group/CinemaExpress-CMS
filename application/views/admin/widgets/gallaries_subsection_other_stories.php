...
if($content['widget_title_link'] == 1){
	$show_simple_tab.=	'<div class="headline2"><h5><a href="'.$widget_section_url.'" >'.$sectionname[Sectionname] .'</a></h5></div>';
}
else{
	$show_simple_tab.=	'<div class="headline2"><h5>'.$sectionname [Sectionname] .'</h5></div>';
}
