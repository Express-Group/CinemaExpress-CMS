...
$show_simple_tab .='<div class="row">
			...
			{
				$show_simple_tab.=	'<h5 class="block-title margin-bottom-10"><span>'.$widget_custom_title.'</span></h5>';
			}
			
			$show_simple_tab.='<div class="most">';
		...
		// Assign summary block starts here
					...
					//  Assign article links block ends hers
						...
						$show_simple_tab.='<div class="most1">';
								...
								$show_simple_tab.='<h6 style="display:none;"><a target="_BLANK" href="'.BASEURL.'authors?q='.str_replace(' ','-',$get_content['author_name']).'">'.$get_content['author_name'].'</a></h6>';
