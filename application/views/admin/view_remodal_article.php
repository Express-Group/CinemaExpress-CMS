...
if($content_type_id==1){
	...
	echo "dsfsd".$ampUrl = MOBILEURL1.'article/'.$uri.'/'.$content_id.'/amp';
	echo "se1".$this->uri->segment(1);
	echo "seb2".$this->uri->segment(2);
	
 $mobileArticleUrl = MOBILEURL1.'article/'.$this->uri->segment(1).'/'.$uri.'/'.$content_id;
 $pubDate = date_format(date_create($page_det['publish_start_date']),"Y-m-d");
...
<noscript>
 ...
 <script type='text/javascript'>
          ...
          if ((navigator.userAgent.match(/(iphone)|(ipod)|(android)|(blackberry)|(windows phone)|(symbian)/i))){
                 ...
                 {
                      var request_uri = "<?php echo $mobileArticleUrl;?>";
