...
if(folder_name == 'niecpan') {
    ...
    CKEDITOR.replace( 'summary', {
		...
		CKEDITOR.replace( 'body_text', {
		  ...
		  {items: [ 'Source','Strike','Subscript','Superscript','NumberedList','BulletedList','Outdent','Indent','Table','HorizontalRule','Smiley','SpecialChar','PageBreak','Iframe','FontAwesome','Blockquote'] }
		  ],  
		    extraPlugins: 'autogrow,html5audio,embed,colordialog,fontAwesome,blockquote', 
					...
					if($.trim($("#mapping_1").html()) == '') {
						...
						var postdata = "content_id="+$("#content_id").val()+"&content_type=1&archive_year="+$("#archive_year").val();
							$.ajax({
									...
									{
										$("#mapping_1").html(data);
										var t=$('#main_section_id option:selected').attr('sectoin_data');
										if(t=='Reviews'){
											var review=$('input[name="review_value"]').val();
											...
											if(review!='' && review < 6){
												...
												alert('Enter Reviews Less than 5');
											}
										}else{
